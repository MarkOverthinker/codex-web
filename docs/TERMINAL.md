...
- `npx playwright test tests/browser/terminal.spec.ts`: desktop/mobile automatic popup connection, absence of command buttons, focused keyboard input, resize, window close/reopen and automatic reconnect without duplicated output or input, using mocked transport.
