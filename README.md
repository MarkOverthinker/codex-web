...
**Next Android candidate:** `0.5.0-preview` (versionCode 12) adds a unified native theme, safer welcome suggestions, clearer composer states and reading behavior, a task-focused workspace, and local Review filters. It is not yet published on the maintained download page. See the [candidate and acceptance record](releases/android/0.5.0-preview.md) and [iteration plans, PRDs and QA](tasks/prd-android-05.md).
