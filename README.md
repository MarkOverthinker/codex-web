...
- Fork a completed primary-conversation user turn into a new side chat; the side chat copies the visible history through that turn and creates its independent Codex thread on first send with `lastTurnId`
