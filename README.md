...
**Current Android release:** `0.5.0-preview` (versionCode 12) is published on the maintained download page. It adds a unified native theme, safer welcome suggestions, clearer composer states and reading behavior, a task-focused workspace, and local Review filters. Install `codex-native-android-0.5.0-preview.apk`; an existing 0.4.2-preview installation signed with the same key can be upgraded in place without uninstalling. See the [release and acceptance record](releases/android/0.5.0-preview.md) and [iteration plans, PRDs and QA](tasks/prd-android-05.md).
